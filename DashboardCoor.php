  ...
  <body>
    <div>
      ...
      <div class="main">
        <div class="topbar sticky-top">
          ...
          <!-- user user -->
          <div class="userImage">
            <h5 class="username"><a href="?page=profil" style="text-decoration: none;">
              <?= $_SESSION["nama"]; ?>
            </a></h5>
            <a href="?page=profil" style="text-decoration: none;">
              <img src="img/4.jpg" width="40px" />
            </a>
          </div>
        </div>
        ...
        <div class="cardBox">
          ...
          <a href="?page=konfirmasi" class="card" style="text-decoration: none;">
            <div class="iconic">
            <i class="bi bi-lock"></i>
            </div>
            <div>
              <div class="CardName">Terpilih</div>
            </div>
          </a>

          <a href="?page=pending" class="card" style="text-decoration: none;">
            <div class="iconic">
          ...
          <a href="?page=komentar" class="card" style="text-decoration: none;">
            ...
            <div>
              <div class="CardName">Komentar Saya</div>
            </div>
          </a>
        </div>
          ...
          <?php 
            ...
            if( isset( $_GET['page'] ) ) {
              ...
              switch ($page) {
                ...
                case 'ruangan':
                  require "ruanganC.php";
                  break;

                case 'konfirmasi':
                  require "ruangan_terisi.php";
                  break;

                case 'pending':
                  require "ruangan_pending.php";
                  break;
    ...
    <div class="modal fade" id="help" tabindex="-1" aria-labelledby="help" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h1 class="modal-title fs-5" id="help">Bantuan</h1>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">
              <a href="https://wa.me/6281382209822?text=Saya%20butuh%20bantuan%20mengenai%20SIRRulas" style="color: white; text-decoration: none" target="_blank">Yes</a> 
            </button>
          </div>
        </div>
      </div>
