...
<head>
  ...
  <title>Visi dan Misi Informatika</title>
</head>
<body>
        ...
        <div class="detailes">
          <div class="detailesNy">
            <div class="cardHeader">
              <h3> Visi dan Misi Informatika</h3>
            </div>
            <div id="container">
              <table>
                <thead>
                ...
                <tbody>
                  <tr>
                    <td>Menjadi Program Studi Teknik Informatika yang mampu menghasilkan lulusan yang unggul dan mandiri bidang rekayasa perangkat lunak di Jawa Barat pada tahun 2028.</td>
                    <td>
