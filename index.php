...
<html lang="en">
  ...
  <body id="home">
    ...
    <section class="jumbotron text-center">
      ...
      <p class="lead">Menejemen ruangan | Sistem Informasi</p><br><br>

      <!-- button -->
      <a class="btn btn-outline-primary"  role="button" href="login.php">Mulai</a>
    ...
    <center>
      <div class="container"><br>
        <img src="img/iroom.png" alt="iroom" width="250px">
      </div>
    </center>
